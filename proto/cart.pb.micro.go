...
type CartService interface {
	...
	ClearCart(ctx context.Context, in *Clean, opts ...client.CallOption) (*Response, error)
...
func (c *cartService) ClearCart(ctx context.Context, in *Clean, opts ...client.CallOption) (*Response, error) {
...
func RegisterCartHandler(s server.Server, hdlr CartHandler, opts ...server.HandlerOption) error {
	type cart interface {
		...
		ClearCart(ctx context.Context, in *Clean, out *Response) error
...
func (h *cartHandler) ClearCart(ctx context.Context, in *Clean, out *Response) error {
